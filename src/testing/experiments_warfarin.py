...
def get_results_table():
    name_folder = "results/warfarin_experiment"
    alpha = 0.05
    seeds = range(100)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--get_parameters_experiment", action="store_true", help="Generate CSV parameter file")
    ...
    parser.add_argument("--method", type=str, choices=["KPT-linear", "KPT-rbf", "KPT-poly", "DR-KPT-rbf", "DR-KPT-poly"], help="Estimator method")
